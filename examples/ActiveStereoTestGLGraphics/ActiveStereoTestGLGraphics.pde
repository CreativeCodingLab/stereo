...
void setup() 
{
  size(640, 480, "stereo.ActiveStereoViewGLGraphics");
...
void draw() 
{
  ...
  //ActiveStereoView glg = (ActiveStereoView) g; //This extends GLGraphics!
  GLGraphics glg = (GLGraphics) g; //This extends GLGraphics!
...
void render(GLGraphics glg)
{
  glg.gl.glColor4f(1f,0f,1f,1f);
  
  glg.gl.glTranslatef(0f,0f,-10f);
  for(int i = 0; i<20; i++) {
    quads[i].display(glg);
  } 
}
